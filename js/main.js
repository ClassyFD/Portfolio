		...
		$('a[href^=mailto]').each(function() {
			...
			$(this).click(function() {
				...
				t = setTimeout(function() {
					// The browser did not respond after 1000ms, so open an alternative URL.
					alert('Email was a success! or if nothing happened, please email fernandodlv32@gmail.com')
				}, 1000);
			});
		});
	})(jQuery)
